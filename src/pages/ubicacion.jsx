...
export default function Ubicacion() {
  ...
  const embed = (lat, lng) => `https://www.google.com/maps?q=${lat},${lng}&hl=es&z=17&output=embed`;
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <div className="w-full rounded-xl shadow-lg border-2 border-[#e82d89] overflow-hidden bg-black/20">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-1">Sucursal Maipú — Complejo Deportivo Don Oscar</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Sede tradicional de RAFC, con enfoque en formación integral y trabajo técnico/táctico.
                  <br />
                  <br />
                  <span className="opacity-80">Dirección: Av. Los Pajaritos 4273, Maipú, Región Metropolitana</span>
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="w-full rounded-xl shadow-lg border-2 border-[#e82d89] overflow-hidden bg-black/20">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-1">Sucursal Estadio Las Rejas</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Nueva sede RAFC orientada al desarrollo futbolístico juvenil, con instalaciones amplias y un entorno
                  inspirador.
                  <br />
